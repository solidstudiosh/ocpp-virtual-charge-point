...
import { meterValuesOcppOutgoing } from "./src/v201/messages/meterValues";
...
// Initialize meter readings manager for OCPP 2.0.1
const meterManager = new MeterReadingsManager(
  vcp,
  meterValuesOcppOutgoing,
  false, // isOcpp16 (false for 2.0.1)
  1,     // connectorId
  1      // evseId
);
...
const gracefulShutdown = createGracefulShutdown(
  ...
  { evseId: 1, connectorId201: 1 }, // OCPP 2.0.1 config
