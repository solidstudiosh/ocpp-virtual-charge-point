...
const callHandlers: { [key: string]: CallHandler } = {
  ...
  GetConfiguration: (vcp: VCP, call: OcppCall<GetConfigurationReq>) => {
    vcp.respond(
      callResult(call,
          JSON.parse('{"configurationKey":[{"key":"SupportedFeatureProfiles","readonly":true,"value":"Core,FirmwareManagement,LocalAuthListManagement,Reservation,SmartCharging,RemoteTrigger"},{"key":"ChargeProfileMaxStackLevel","readonly":true,"value":"99"},{"key":"HeartbeatInterval","readonly":false,"value":"300"},{"key":"GetConfigurationMaxKeys","readonly":true,"value":"99"},{"key":"G_TimeZone","readonly":false,"value":"UTC+00:00"}]}')
          // keba KC-P30
